...
<body style="background-color:#757171;">
  ...
  <div style="display: flex; flex-wrap: wrap; justify-content: center; margin-top: 10px; background-color:#757171; margin-bottom:35px;">
    <div class="card" style="width: 18rem; background-color: #f1f1f1; margin: 12px;" onclick="redirectTo('https://example.com/produto5')"> <!--Site para ser redirecionado-->
    ...
    <div class="card" style="width: 18rem; background-color: #f1f1f1; margin: 12px;" onclick="redirectTo('https://example.com/produto6')"> <!--Site para ser redirecionado-->
      <img id="card6" src="casaco.jpg" class="card-img-top">
      <div class="card-body">
    ...
    <div class="card" style="width: 18rem;background-color: #f1f1f1; margin: 12px;" onclick="redirectTo('https://example.com/produto7')"> <!--Site para ser redirecionado-->
    ...
    <div class="card" style="width: 18rem;background-color: #f1f1f1; margin: 12px;" onclick="redirectTo('https://example.com/produto8')"> <!--Site para ser redirecionado-->
